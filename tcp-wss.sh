...
install_ssrust(){
    wget https://raw.githubusercontent.com/dolaxi/v2ray-wss/main/ss-rust.sh && bash ss-rust.sh
}

install_reality(){
    wget https://raw.githubusercontent.com/dolaxi/v2ray-wss/main/reality.sh && bash reality.sh
}

install_hy2(){
    wget https://raw.githubusercontent.com/dolaxi/v2ray-wss/main/hy2.sh && bash hy2.sh
}

install_https(){
    wget https://raw.githubusercontent.com/dolaxi/v2ray-wss/main/https.sh && bash https.sh
}
